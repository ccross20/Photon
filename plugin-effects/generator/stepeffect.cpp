...
StepEffectEditor::StepEffectEditor(StepEffect *t_effect):ChannelEffectEditor(t_effect),m_effect(t_effect)
{
    ...
    connect(freqSpin, &keira::NumberScrubField::valueChanged, this, &StepEffectEditor::frequencyChanged);


    keira::NumberScrubField *ampSpin = new keira::NumberScrubField;
    ampSpin->setValue(m_effect->amplitude());
    connect(ampSpin, &keira::NumberScrubField::valueChanged, this, &StepEffectEditor::amplitudeChanged);
